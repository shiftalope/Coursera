#This script plots a timeline of "Global Active Power" values from household_power_consumption data
...
#Plot Global_active_power as a function of DateTime
plot(strptime(myData$Date_Time, format="%d/%m/%Y %H:%M:%S"), myData$Global_active_power, ylab ="Global Active Power (kilowatts)", xlab=" ",type="l")
